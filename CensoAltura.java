...
public class CensoAltura {
    ...
    public static void main(String[] args) {
        ...
        int i, indiceMaior = 0, indiceMenor = 0, qtMasculino = 0, qtFeminino = 0;
    ...
    float totalPessoas = altura.length;
        ...
        System.out.printf("a) A pessoa %d é de altura %.2f é a mais alta\n", indiceMaior+1, maior);
        System.out.printf("   A pessoa %d é de altura %.2f é a mais baixa\n\n", indiceMenor+1, menor);
